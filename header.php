...
<head>
  ...
  <title>Easy Accounts | Welcome</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo HOMEURL; ?>index.php" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>Easy Accounts</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Easy Accounts</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <!-- <ul class="menu">
                  <li> --><!-- start message -->
                    <!-- <a href="#">
                      <div class="pull-left"> -->
                        <!-- User Image -->
                        <!-- <img src="<?php //echo HOMEURL; ?>dist/img/avatar3.png" class="img-circle" alt="User Image">
                      </div> -->
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo HOMEURL; ?>dist/img/avatar5.png" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo HOMEURL; ?>signout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
